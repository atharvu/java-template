...
//     static String[] responses = {"Sorry, I didn't quite understand", "Sorry, don't really get what you're trying to say", "Didn't understand, could you please repeat", "System malfuction, can you please repeat what you said", "Totally didn't understand, please say that again"};

//     static Shoe[] excercise_soccer_budget = {new Shoe("Nike Streetgato", 90.00), new Shoe("Samba Messi", 100.00), new Shoe("Nike Tiempo Legend 10 Academy", 85.00)};
//     static Shoe[] excercise_soccer_mid = {new Shoe("Nike Lunargato II", 120.00), new Shoe("COPA Mundial Soccer Shoes", 180.00), new Shoe("Manchester United Gazelle Shoes", 110.00)};
//     static Shoe[] excercise_soccer_premium = {new Shoe("Nike Phanton GX 2 Elite", 260.00), new Shoe("F50 Elite Soft Ground", 270.00), new Shoe("Nike SuperFly 9 Elite", 295.00)};
//     static Shoe[] excercise_basketball_budget = {new Shoe("Giannis Immortality 4", 85.00), new Shoe("Nike G.T Cut Academy", 95.00), new Shoe("Nike Impact 4", 95.00)};
//     static Shoe[] excercise_basketball_mid = {new Shoe("Anthony Edwards 1 Pure Ruby", 120.00), new Shoe("Ja 2 Nightmare", 120.00), new Shoe("Giannis Freak 6", 140.00)};
//     static Shoe[] excercise_basketball_premium = {new Shoe("Kobe Grinches", 785.00), new Shoe("Nike Lebron XXi", 225.00)};
//     static Shoe[] excercise_running_budget = {new Shoe("Runfalcon 3 Cloudfoam", 65.00), new Shoe("Nike Rival Fly 4", 100.00), new Shoe("Nike Jounrey Run PRM", 100.00)};
//     static Shoe[] excercise_running_mid = {new Shoe("Nike Pegasus 41", 140.00), new Shoe("Nike Zoom Fly 6", 170.00), new Shoe("Ultraboost 5X", 180.00)};
//     static Shoe[] excercise_running_premium = {new Shoe("Nike Vaporfly 3", 260.00), new Shoe("Nike DragonFly 2 Elite", 205.00), new Shoe("Nike Invincible 3", 210.00)};
//     static Shoe[] style_budget = {new Shoe("Nike Killshot", 90.00), new Shoe("Vans Authentic", 55.00), new Shoe("Vans Old Skool", 70.00)};
//     static Shoe[] style_mid = {new Shoe("Air Jordan 1 Mid", 125.00), new Shoe("Air Jordan 1 Low", 115.00), new Shoe("Jordan 6 Rings", 170.00)};
//     static Shoe[] style_premium = {new Shoe("Air Jordan 1 High", 200.00), new Shoe("SANTONI Leather Sneakers", 480.00), new Shoe("Common Projects", 400.00)};
//     static Shoe[] casual = {new Shoe("Sambas", 100.00), new Shoe("Air Force 1", 115.00), new Shoe("Nike Dunk Low", 115.00)};
//     static Shoe[] luxary = {new Shoe("Air Jordan 1 Dior", 6610.00), new Shoe("Louis Vuitton Air Force", 11000.00), new Shoe("Carhartt Jordan 4 Retro Eminem", 40000.00)};
...
//         System.out.println("Also, a top secret luxary collection of sneakers that will help you certify GOAT status.");
...
//             System.out.println("Are you looking for Stylish, Excericse, Casual or a surprise?");
...
//             else {
//                 System.out.println(responses[(int) (Math.random() * 5)]);
//             }
//         }
...
//                 System.out.println(RED + "The first shoe is called " + excercise_running_premium[0].getName() + RESET);
//                 System.out.println(GREEN + "The price of this one is $" + excercise_running_premium[0].getPrice() + RESET);
//                 System.out.println(RED + "The next shoe is called " + excercise_running_premium[1].getName() + RESET);
//                 System.out.println(GREEN + "These will cost you $" + excercise_running_premium[1].getPrice() + RESET);
//                 System.out.println(RED + "The last shoe that we have is called " + excercise_running_premium[2].getName() + RESET);
//                 System.out.println(GREEN + "These will cost $" + excercise_running_premium[2].getPrice() + RESET);

//                 Scanner f = new Scanner(System.in);
//                 System.out.println(YELLOW + "Did you like the shoes that I recommended. Please respond with a yes or no for my convenience." + RESET);
//                 rating = f.nextLine();
//                 lowered_rating = rating.toLowerCase();

//                 if(lowered_rating.contains("yes")) {
//                     System.out.println(GREEN + "Thanks! Glad you enjoyed the shoes!" + RESET);
//                 }

//                 else if(lowered_rating.contains("no")) {
//                     System.out.println(RED + "Unfortunately, those are the only shoes that I can recommend" + RESET);
//                 }
...
//                 System.out.println("Nice choice, I have 3 shoes for you.");
//                 System.out.println(RED + "The first shoe is called " + excercise_running_budget[0].getName() + RESET);
//                 System.out.println(GREEN + "The price of this one is $" + excercise_running_budget[0].getPrice());
//                 System.out.println(RED + "The next shoe is called " + excercise_running_budget[1].getName() + RESET);
//                 System.out.println(GREEN + "These will cost you $" + excercise_running_budget[1].getPrice() + RESET);
//                 System.out.println(RED + "The last shoe that we have is called " + excercise_running_budget[2].getName() + RESET);
...
//                 if(lowered_rating.contains("yes")) {
//                     System.out.println("Thanks! Glad you enjoyed the shoes!");
//                 }

//                 else if(lowered_rating.contains("no")) {
//                     System.out.println("Unfortunately, those are the only shoes that I can recommend");
//                 }
...
//                 System.out.println("Nice choice, I have 3 shoes for you.");
//                 System.out.println(RED + "The first shoe is called " + excercise_running_mid[0].getName() + RESET);
//                 System.out.println(GREEN + "The price of this one is $" + excercise_running_mid[0].getPrice() + RESET);
//                 System.out.println(RED + "The next shoe is called " + excercise_running_mid[1].getName() + RESET);
//                 System.out.println(GREEN + "These will cost you $" + excercise_running_mid[1].getPrice() + RESET);
//                 System.out.println(RED + "The last shoe that we have is called " + excercise_running_mid[2].getName() + RESET);
...
//             if(lowered_range.contains("premium")) {
//                 System.out.println("Nice choice, I have 3 shoes for you.");
//                 System.out.println(RED + "The first shoe is called " + excercise_basketball_premium[0].getName() + RESET);
//                 System.out.println(GREEN + "The price of this one is $" + excercise_basketball_premium[0].getPrice() + RESET);
//                 System.out.println(RED + "The next shoe is called " + excercise_basketball_premium[1].getName() + RESET);
//                 System.out.println(GREEN + "These will cost you $" + excercise_basketball_premium[1].getPrice() + RESET);
//                 System.out.println(RED + "The last shoe that we have is called " + excercise_basketball_premium[2].getName() + RESET);
...
//             if(lowered_range.contains("budget")) {
//                 System.out.println("Nice choice, I have 3 shoes for you.");
//                 System.out.println(RED + "The first shoe is called " + excercise_basketball_budget[0].getName() + RESET);
//                 System.out.println(GREEN + "The price of this one is $" + excercise_basketball_budget[0].getPrice() + RESET);
//                 System.out.println(RED + "The next shoe is called " + excercise_basketball_budget[1].getName() + RESET);
//                 System.out.println(GREEN + "These will cost you $" + excercise_basketball_budget[1].getPrice() + RESET);
//                 System.out.println(RED + "The last shoe that we have is called " + excercise_basketball_budget[2].getName() + RESET);
...
//             if(lowered_range.contains("mid")) {
//                 System.out.println("Nice choice, I have 3 shoes for you.");
//                 System.out.println(RED + "The first shoe is called " + excercise_basketball_mid[0].getName() + RESET);
//                 System.out.println(GREEN + "The price of this one is $" + excercise_basketball_mid[0].getPrice() + RESET);
//                 System.out.println(RED + "The next shoe is called " + excercise_basketball_mid[1].getName() + RESET);
//                 System.out.println(GREEN + "These will cost you $" + excercise_basketball_mid[1].getPrice() + RESET);
//                 System.out.println(RED + "The last shoe that we have is called " + excercise_basketball_mid[2].getName() + RESET);
...
//             if(lowered_range.contains("premium")) {
//                 System.out.println("Nice choice, I have 3 shoes for you.");
//                 System.out.println(RED + "The first shoe is called " + excercise_soccer_premium[0].getName() + RESET);
//                 System.out.println(GREEN + "The price of this one is $" + excercise_soccer_premium[0].getPrice() + RESET);
//                 System.out.println(RED + "The next shoe is called " + excercise_soccer_premium[1].getName() + RESET);
//                 System.out.println(GREEN + "These will cost you $" + excercise_soccer_premium[1].getPrice() + RESET);
//                 System.out.println(RED + "The last shoe that we have is called " + excercise_soccer_premium[2].getName() + RESET);
...
//             if(lowered_range.contains("budget")) {
//                 System.out.println("Nice choice, I have 3 shoes for you.");
//                 System.out.println(RED + "The first shoe is called " + excercise_soccer_budget[0].getName() + RESET);
//                 System.out.println(GREEN + "The price of this one is $" + excercise_soccer_budget[0].getPrice() + RESET);
//                 System.out.println(RED + "The next shoe is called " + excercise_soccer_budget[1].getName() + RESET);
//                 System.out.println(GREEN + "These will cost you $" + excercise_soccer_budget[1].getPrice() + RESET);
//                 System.out.println(RED + "The last shoe that we have is called " + excercise_soccer_budget[2].getName() + RESET);
...
//             if(lowered_range.contains("mid")) {
//                 System.out.println("Nice choice, I have 3 shoes for you.");
//                 System.out.println(RED + "The first shoe is called " + excercise_soccer_mid[0].getName() + RESET);
//                 System.out.println(GREEN + "The price of this one is $" + excercise_soccer_mid[0].getPrice() + RESET);
//                 System.out.println(RED + "The next shoe is called " + excercise_soccer_mid[1].getName() + RESET);
//                 System.out.println(GREEN + "These will cost you $" + excercise_soccer_mid[1].getPrice() + RESET);
//                 System.out.println(RED + "The last shoe that we have is called " + excercise_soccer_mid[2].getName() + RESET);
...
//         System.out.println(RED + "The first pair is the Addidas " + casual[0].getName() + RESET);
//         System.out.println(GREEN + "These will cost $" + casual[0].getPrice() + RESET);
//         System.out.println(RED + "The second pair is the " + casual[1].getName() + RESET);
//         System.out.println(GREEN + "These will cost $" + casual[1].getPrice() + RESET);
//         System.out.println(RED + "The last pair is the " + casual[2].getName() + GREEN);
//         System.out.println(GREEN + "These will cost $" + casual[2].getPrice() + RESET);

//         Scanner q = new Scanner(System.in);
//         System.out.println(YELLOW + "Did you like the shoes that we recommended. Please respond with a yes or no for my convenience" + RESET);
//         rating = q.nextLine();
//         lowered_rating = rating.toLowerCase();

//         if(lowered_rating.contains("yes")) {
//             System.out.println("Thank You So Much! Glad you liked the shoes!");
//         }

//         else if(lowered_rating.contains("no")) {
//             System.out.println("Sorry, those are the only shoes that I know of based on what you wanted.");
//         }
...
//         System.out.println(YELLOW + "Mid: 100-200" + RESET);
//         System.out.println(YELLOW + "Premium: 200+" + RESET);
//         System.out.println(YELLOW + "We even offer an exclusive luxary collection." + RESET);

//         while(true) {
//             Scanner r = new Scanner(System.in);
//             System.out.println("Would you like budget, mid, premium or luxary shoes?");
//             range = r.nextLine();
//             lowered_range = range.toLowerCase();

//             if(lowered_range.contains("budget") || lowered_range.contains("mid") || lowered_range.contains("premium") || lowered_range.contains("luxary")) {
//                 break;
//             }
...
//         if(lowered_range.contains("budget")) {
//             System.out.println(RED + "The first pair is " + style_budget[0].getName() + RESET);
//             System.out.println(GREEN + "These will cost $" + style_budget[0].getPrice() + RESET);
//             System.out.println(RED + "The second pair is " + style_budget[1].getName() + RESET);
//             System.out.println(GREEN + "These will cost $" + style_budget[1].getPrice() + RESET);
//             System.out.println(RED + "The final pair is " + style_budget[2].getName() + RESET);
...
//             if(lowered_rating.contains("yes")) {
//                 System.out.println("Thanks! Hope you enjoy the shoes!");
//             }

//             else if(lowered_rating.contains("no")) {
//                 System.out.println("Unforutnately, those are the only shoes that I can recommend.");
//             }
...
//         if(lowered_range.contains("mid")) {
//             System.out.println(RED + "The first pair is " + style_mid[0].getName() + RESET);
//             System.out.println(GREEN + "These will cost $" + style_mid[0].getPrice() + RESET);
//             System.out.println(RED + "The second pair is " + style_mid[1].getName() + RESET);
//             System.out.println(GREEN + "These will cost $" + style_mid[1].getPrice() + RESET);
//             System.out.println(RED + "The final pair is " + style_mid[2].getName() + RESET);
...
//         if(lowered_range.contains("premium")) {
//             System.out.println(RED + "The first pair is " + style_premium[0].getName() + RESET);
//             System.out.println(GREEN + "These will cost $" + style_premium[0].getPrice() + RESET);
//             System.out.println(RED + "The second pair is " + style_premium[1].getName() + RESET);
//             System.out.println(GREEN + "These will cost $" + style_premium[1].getPrice() + RESET);
//             System.out.println(RED + "The final pair is " + style_premium[2].getName() + RESET);
...
//         if(lowered_range.contains("luxary")) {
//             System.out.println(RED + "The first pair is " + luxary[0].getName() + RESET);
//             System.out.println(GREEN + "These will cost $" + luxary[0].getPrice() + RESET);
//             System.out.println(RED + "The second pair is " + luxary[1].getName() + RESET);
//             System.out.println(GREEN + "These will cost $" + luxary[1].getPrice() + RESET);
//             System.out.println(RED + "The final pair is " + luxary[2].getName() + RESET);
//             System.out.println(GREEN + "These will cost $" + luxary[2].getPrice() + RESET);
